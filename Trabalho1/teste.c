...
int main(int argc, char *argv[]){
    ...
    int bytes_lidos = 0;
    int arquivo = open("test-07.x", O_RDONLY);
    ...
    close(arquivo);
    arquivo = open("test-07.x", O_RDONLY);
    ...
    //if(argv[1][1] == 'h'){
        printa_tabela_secoes(secoes, n_secoes, (unsigned char *)"test-07.x");
        //return 0;
    //}
    ...
    //if(argv[1][1] == 't'){
        printa_tabela_simbolos(secoes, simbolos, n_simbolos, n_secoes, (unsigned char *)"test-07.x");
        //return 0;
    //}
    ...
    //if(argv[1][1] == 'd'){
      printa_instrucoes(secoes, simbolos, instrucoes, n_instrucoes, n_simbolos, (unsigned char *)"test-07.x", n_text);
    //}
